            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="relative p-6 flex-auto mx-10">
                    ...
                    <div class="mb-4">
                        ...
                        @if ($errors->has('name'))
                            <p class="text-red-500 mb-3 text-sm" role="alert">
                                {{ $errors->first('name') }}
                            </p>
                        @endif
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input name="email" class="appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 placeholder-serv-text text-xs" id="email" type="email" placeholder="name@mail.com" required>
                ...
                <div class="px-6 pb-6 rounded-b-xl mx-10">
                    ...
                    <p href="#" class="text-center py-5">Already have account? 
                        <a href="#" class="text-serv-button" onclick="toggleModal('loginModal');toggleModal('registerModal') ">Sign in</a>
                    </p>
                </div>
